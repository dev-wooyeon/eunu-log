            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 shadow-xl">
                <div className="space-y-6">
                    <div className="flex flex-wrap gap-4 items-center justify-between">
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-semibold transition-all ${algorithm === 'DFS'
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-semibold transition-all ${algorithm === 'BFS'
                                    ? 'bg-blue-500 text-white shadow-lg'
                                    : 'bg-slate-700 text-slate-300 hover:bg-slate-600'
                                    }`}
                            >
                        ...
                        <div className="flex gap-2">
                            ...
                            >
                                {isPlaying ? '⏸ 일시정지' : (currentStep >= traversalPath.length && traversalPath.length > 0) ? '🔄 다시보기' : '▶ 재생 시작'}
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        <h4 className="text-white font-bold text-sm opacity-80">탐색 순서</h4>
                            ...
                            {traversalPath.length > 0 ? (
                                <div className="flex flex-wrap gap-2">
                                    {traversalPath.map((nodeId, index) => (
                                        <span
                                            key={index}
                                            className={`px-3 py-1.5 rounded-lg font-semibold transition-all text-xs ${index < currentStep
                                ...
                                <span className="text-slate-500 text-sm italic">알고리즘을 선택하고 재생 버튼을 눌러보세요</span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2 pt-4 border-t border-slate-700/50">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-300 text-xs">대기중 (Queue/Stack)</span>
                        </div>
                        <div className="flex items-center gap-2">
