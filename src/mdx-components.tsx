...
const BinarySearchVisualization = dynamic(
  () => import('@/components/visualization').then(mod => ({ default: mod.BinarySearchVisualization }))
);
const DPVisualization = dynamic(
  () => import('@/components/visualization').then(mod => ({ default: mod.DPVisualization }))
);
const GraphTraversalVisualization = dynamic(
  () => import('@/components/visualization').then(mod => ({ default: mod.GraphTraversalVisualization }))
);
const SlidingWindowVisualization = dynamic(
  () => import('@/components/visualization').then(mod => ({ default: mod.SlidingWindowVisualization }))
);
const SortingVisualization = dynamic(
  () => import('@/components/visualization').then(mod => ({ default: mod.SortingVisualization }))
);
const TwoPointerVisualization = dynamic(
  () => import('@/components/visualization').then(mod => ({ default: mod.TwoPointerVisualization }))
);
