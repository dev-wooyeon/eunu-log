...
- `src/components/layout/Header/MobileBottomNav.tsx`
- `src/components/layout/Header/useScrollVisibility.ts`
...
- `npm run test:e2e`
  ...
  - `e2e/theme-regression.spec.ts`
  - `e2e/safe-area.spec.ts`
  - `e2e/session-storage-fallback.spec.ts`
